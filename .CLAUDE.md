...
### 4. Seed Data as a Source of Truth
- While in development (.env -> NEXT_AUTH_DEVELOPMENT="TRUE") we can freely reset the database content and reseed.
- Therefore, during development, never create individual scripts to add new data. 
- Always add new data via the seed file.
